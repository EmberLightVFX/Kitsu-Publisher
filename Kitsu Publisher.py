...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        # TEMP #
        '''
        self.le_kitsuURL.setText("https://kojannas.myds.me:9131/")
        self.le_username.setText("jacob@emberlight.se")
        self.le_password.setText("kladdkaka")
        self.rb_doXML.setChecked(False)
        self.rb_doFolder.setChecked(True)
        self.le_infopath.setText(
            "G:\\OTHER\\Python\\filer")
        '''
        # TEMP #
